...
class App
{
    ...
    public function __construct($accessKeyId, $accessKeySecret)
    {
        ...
        App::$accessKeySecret   = $accessKeySecret;
    }
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = App::$accessKeyId; // AccessKeyId

        $accessKeySecret = App::$accessKeySecret; // AccessKeySecret
     ...
     * @return stdClass
     */
    public function sendSms($mobile, $sign, $temp_id, $param, $out_id = false, $exrend = false) {
        ...
        if ($exrend) {
            ...
            $request->setSmsUpExtendCode($exrend);
        }
